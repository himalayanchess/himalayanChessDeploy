...
const LitchesTournamentWinners = ({
  ...
  return (
    <div className="flex flex-col">
      <p className="text-gray-500 font-bold flex items-center">
        <Medal />
        <span className="ml-1">Litches Winners List</span>
      </p>
...
export default LitchesTournamentWinners;
