...
const BaicHcaCircuitSeriesTournamentInfo = ({
      ...
      <div className="bg-gray-50 rounded-xl  p-4 ">
        <div className="">
          <p className="text-sm text-gray-500">
            Hca Circuit Series Tournament Name
          </p>
          <div className="flex items-center">
            {/* <School className="text-gray-500" /> */}
            <p className="font-bold text-2xl ml-1 ">
              {hcaCircuitSeriesTournamentRecord?.tournamentName}
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 mt-2 gap-2">
          <div>
            ...
            <p className="font-medium text-md flex items-center">
              ...
              <span className="ml-1">
                {hcaCircuitSeriesTournamentRecord?.startDate
                  ? formatDate(hcaCircuitSeriesTournamentRecord.startDate)
                  : "N/A"}
              </span>
            </p>
          </div>
          <div>
            ...
            <p className="font-medium text-md flex items-center">
              <EventOutlinedIcon className="text-gray-500" />
              <span className="ml-1">
                {hcaCircuitSeriesTournamentRecord?.endDate
                  ? formatDate(hcaCircuitSeriesTournamentRecord.endDate)
                  : "N/A"}{" "}
              </span>
            </p>
          </div>
        ...
        <div className="grid grid-cols-2 mt-2 gap-2">
          <div>
            ...
            <p className="font-medium text-md flex items-center">
              ...
              {hcaCircuitSeriesTournamentRecord?.branchName &&
              hcaCircuitSeriesTournamentRecord?.branchId ? (
          ...
          <div className="flex justify-end items-center">
            <span
              className={` px-3 py-1 text-md font-semibold rounded-full flex items-center ${
                hcaCircuitSeriesTournamentRecord?.tag
            ...
            >
              ...
              {hcaCircuitSeriesTournamentRecord?.tag?.toLowerCase() ==
              "hcacircuitseries"
                ? "HCA Circuit Series"
                : "N/A"}
            </span>
          ...
          <div className="">
            ...
            <p className="text-gray-500 text-md flex items-center text-md font-medium">
              {hcaCircuitSeriesTournamentRecord?.tournamenturl ? (
                <div className="flex items-center">
                  <SquareArrowOutUpRight size={18} />
                  <Link
                    href={hcaCircuitSeriesTournamentRecord.tournamenturl}
                    target="_blank"
        ...
        <div className="grid grid-cols-3 mt-2 gap-2">
          ...
          <div className="col-span-1">
            ...
            <p className="font-bold text-gray-500 text-md flex items-center">
              ...
              <span className="ml-1">
                {hcaCircuitSeriesTournamentRecord?.isRated ? "Yes" : "No"}
              </span>
            </p>
          </div>
          ...
          <div className="col-span-1">
            ...
            <p className="font-medium text-gray-500 text-md flex items-center">
              <span className="ml-1">
                {hcaCircuitSeriesTournamentRecord?.fideUrl ? (
                  <Link
                    href={hcaCircuitSeriesTournamentRecord.fideUrl}
                    target="_blank"
                    rel="noopener noreferrer"
          ...
          <div className="col-span-1">
            ...
            <p className="font-medium text-gray-500 text-md flex items-center">
              <span className="ml-1">
                {hcaCircuitSeriesTournamentRecord?.chessResultsUrl ? (
                  <Link
                    href={hcaCircuitSeriesTournamentRecord.chessResultsUrl}
                    target="_blank"
                    rel="noopener noreferrer"
                    className=" underline flex items-center hover:text-blue-500"
                  >
        ...
        <div className="grid grid-cols-3 mt-2 gap-2">
          ...
          <div className="col-span-1">
            ...
            <p className="font-bold text-gray-500 text-md flex items-center">
              ...
              <span className="ml-1">
                {hcaCircuitSeriesTournamentRecord?.chiefArbiter
        ...
        <div className="grid grid-cols-3 mt-2 gap-2">
          <div className="col-span-1">
            ...
            <p className="font-bold text-gray-500 text-md flex items-center">
              ...
              <span className="ml-1">
                {hcaCircuitSeriesTournamentRecord?.tournamentType || "N/A"}{" "}
              </span>
            </p>
          </div>
          <div className="col-span-1">
            ...
            <p className="font-bold text-gray-500 text-md flex items-center text-lg ">
              ...
              <span className="ml-1">
                <span>
                  {hcaCircuitSeriesTournamentRecord?.clockTime?.initialTime
                    ? `${hcaCircuitSeriesTournamentRecord.clockTime.initialTime} mins`
                    : "N/A"}
                </span>{" "}
              </span>
            </p>
          ...
          <div className="col-span-1">
            ...
            <p className="font-bold text-gray-500 text-md flex items-center text-lg ">
              ...
              <span className="ml-1">
                <span>
                  {hcaCircuitSeriesTournamentRecord?.clockTime?.increment
                    ? `${hcaCircuitSeriesTournamentRecord.clockTime.increment} sec`
                    : "N/A"}
                </span>
              </span>
            </p>
          ...
          <div className="col-span-1">
            ...
            <p className="font-bold text-gray-500 text-md flex items-center text-lg ">
              ...
              <span className="ml-1">
                {hcaCircuitSeriesTournamentRecord?.totalParticipants || 0}
              </span>
            </p>
          </div>
          ...
          <div className="col-span-1">
            ...
            <p className="font-bold text-gray-500 text-md flex items-center text-lg ">
              ...
              <span className="ml-1">
                {hcaCircuitSeriesTournamentRecord?.totalRounds || 0}
              </span>
            </p>
          </div>
        </div>
...
export default BaicHcaCircuitSeriesTournamentInfo;
