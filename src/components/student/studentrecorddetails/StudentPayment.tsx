...
const StudentPayment = ({ studentRecord }: any) => {
  // session
            ...
            {allFilteredActiveSelectedStudentsPaymentRecordsList?.map(
              (paymentRecord: any, index: number) => (
                <div
                  ...
                  className="grid grid-cols-[50px,repeat(6,1fr)] gap-2 px-4 py-2 border-b border-gray-200 items-center hover:bg-gray-50 transition-all"
                >
