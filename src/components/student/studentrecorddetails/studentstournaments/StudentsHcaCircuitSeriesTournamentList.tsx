...
import { exportStudentsOtherTournamentsToExcel } from "@/helpers/exportToExcel/studenttournaments/exportStudentsOtherTournamentsToExcel";
import { BadgePlus, Medal } from "lucide-react";
import { exportStudentsHcaCircuitSeriesTournamentsToExcel } from "@/helpers/exportToExcel/studenttournaments/exportStudentsHcaCircuitSeriesTournamentsToExcel";

dayjs.extend(utc);
dayjs.extend(timezone);
let timeZone = "Asia/Kathmandu";

const StudentsHcaCircuitSeriesTournamentList = ({
  studentId,
  studentName,
  tournamentList,
  loading,
  ...
  //export to excel
  const exportToExcel = () => {
    exportStudentsHcaCircuitSeriesTournamentsToExcel(
      tournamentList,
      studentId,
      studentName
    );
              ...
              return (
                ...
                >
                  ...
                  <span className="py-3 text-left  text-xs  text-gray-600 flex items-center">
                    <Medal size={15} />
                    <span className="ml-1">
                      {selectedStudent?.circuitPoints || "N/A"}
                    </span>
                  </span>
...
export default StudentsHcaCircuitSeriesTournamentList;
