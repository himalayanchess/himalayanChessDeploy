...
import { exportStudentsTournamentsOrganizedByHcaToExcel } from "@/helpers/exportToExcel/studenttournaments/exportStudentsTournamentsOrganizedByHcaToExcel";

dayjs.extend(utc);
dayjs.extend(timezone);
let timeZone = "Asia/Kathmandu";

const StudentsTournamentsOrganizedByHcaList = ({
  studentId,
  studentName,
  tournamentList,
  loading,
  ...
  //export to excel
  const exportToExcel = () => {
    exportStudentsTournamentsOrganizedByHcaToExcel(
      tournamentList,
      studentId,
      studentName
    );
...
export default StudentsTournamentsOrganizedByHcaList;
