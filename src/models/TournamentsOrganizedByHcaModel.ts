...
const TournamentsOrganizedByHcaSchema = new mongoose.Schema(
  {
    tournamentName: { type: String, default: "" },
    tournamentUrl: { type: String, default: "" },
    tag: { type: String, default: "tournamentsorganizedbyhca" },
...
const TournamentsOrganizedByHca =
  mongoose.models.TournamentsOrganizedByHca ||
  mongoose.model("TournamentsOrganizedByHca", TournamentsOrganizedByHcaSchema);

export default TournamentsOrganizedByHca;
