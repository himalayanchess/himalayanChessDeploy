...
const TournamentsHcaHelpInSchema = new mongoose.Schema(
  {
    tournamentName: { type: String, default: "" },
    tournamentUrl: { type: String, default: "" },
    tag: { type: String, default: "tournamentshcahelpin" },
...
const TournamentsHcaHelpIn =
  mongoose.models.TournamentsHcaHelpIn ||
  mongoose.model("TournamentsHcaHelpIn", TournamentsHcaHelpInSchema);

export default TournamentsHcaHelpIn;
