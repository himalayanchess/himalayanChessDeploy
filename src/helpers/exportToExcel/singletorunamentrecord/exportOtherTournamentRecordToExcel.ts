...
export function exportOtherTournamentRecordToExcel(tournament: any) {
  ...
  // Conditionally include Chief Arbiter fields
  ...
  XLSX.writeFile(
    wb,
    `Other_Tournament_${tournament?.tournamentName}_${dayjs()
      .tz(timeZone)
